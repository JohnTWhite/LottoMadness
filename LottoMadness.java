...
public class LottoMadness extends JFrame{
	...
	LottoEvent  lottoLove = new LottoEvent(this);
	...
	public LottoMadness() {
		...
		quickpick.addItemListener(lottoLove);
		personal.addItemListener(lottoLove);
		stop.addActionListener(lottoLove);
		play.addActionListener(lottoLove);
		reset.addActionListener(lottoLove);
		...
		GridLayout layout4 = new GridLayout(2,3);
